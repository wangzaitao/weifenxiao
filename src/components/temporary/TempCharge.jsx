...
import {isIntNumber, addCookie} from '../../utils/common';
import * as ContentAPI from '../../api/content';
import * as GlobalConfig from '../../constants/Config';

require('./temporary.css');

class TempCharge extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className="bgc-white user-charge">
        ...
        <Dialog clz="pay-dialog" confirm="已支付并查看" cancel="更换支付方式" content="请根据您的支付情况，选择下面的按钮" show={this.state.showDialog}
