...
class ChargeResult extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <div className="bgc-white user-charge-result">
        ...
        <div className="next-actions">
          <CustomLink to="/" className="home" isOuterURL={true}><div>返回首页</div></CustomLink>
          <CustomLink to="/user/my_charge_record" className="my-charge-record"><div>查看充值记录</div></CustomLink>
        </div>
      </div>
    );
  }
