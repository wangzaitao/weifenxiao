...
class Type extends Component {
	...
	componentDidMount() {
		...
		$(document.body).on("click", function (e) {
			if (e.target.offsetParent.id != "div_Trip_StartDate") {
				this._hideCalendar();
			}
		}.bind(this))
	}
	...
	_saveBasic() {
		...
		else if ($.trim($("#CategoryID").val()) == "0") {
			alert('产品分类不能为空');
			return false;
		}
		else if (this.state.pdtImgUrl == "") {
			alert('产品图片不能为空');
			return false;
		}
		else if ($.trim($("#PdtBrief").val()) == "") {
			alert('产品概述不能为空');
			return false;
		}
		else if ($.trim($("#PdtDetail").val()) == "") {
			alert('产品详情不能为空');
			return false;
		}
		else if ($.trim($("#RetailPrice").val()) == "") {
			alert('门市价不能为空');
			return false;
		}
		else if ($.trim($("#MemberPrice").val()) == "") {
			alert('会员价不能为空');
			return false;
		}
		else if ($.trim($("#ListingPrice").val()) == "") {
			alert('同行价不能为空');
			return false;
		}
		else if ($.trim($("#EnfantPrice").val()) == "") {
			alert('儿童价不能为空');
			return false;
		}
	...
	_savePrice() {
		...
		for (var i = 0; i < $("#tbl_Price tbody").find("tr").length; i++) {
			if ($("#tbl_Price tbody").find("tr:eq(" + i + ")").children("td:eq(0)").find("input").val() == "") {
				flag = false;
			}
			var obj = {
	...
	_addPrice() {
		...
		$("#price").find("tr:last").find("input").val("");
		...
		if (this.state.pPrice.length > 0) {
			pPriceDom = this.state.pPrice.map((item, index) => {
				return (
					<tr>
						<td>
							<div><input type="text" name="PriceType" defaultValue={item.PriceType}/></div>
						</td>
						<td>
							<div><input type="text" name="MenShiPrice" defaultValue={item.MenShiPrice}/></div>
						</td>
						<td>
							<div><input type="text" name="HuiYuanPrice" defaultValue={item.HuiYuanPrice}/></div>
						</td>
						<td>
							<div><input type="text" name="TongHangPrice" defaultValue={item.TongHangPrice}/></div>
						</td>
						<td>
							<div><input type="text" name="ErTongPrice" defaultValue={item.ErTongPrice}/></div>
						</td>
						<td>
							<div><input type="text" name="PriceIntroduces" defaultValue={item.PriceIntroduces}/></div>
						</td>
					</tr>
				);
			});
							...
							<div className="form-horizontal" role="form">
								<div className="form-group">
									<label className="col-sm-3 control-label">
										<font className="required">*</font>产品名称
									</label>
								...
								<div className="form-group">
									<label for="" className="col-sm-3 control-label"><font className="required">*</font>产品分类</label>
									<div className="col-sm-9">
								...
								<div className="form-group" style={{ width:"100%"}}>
									<label className="col-sm-3 control-label" style={{width:"161px"}}>
										<font className="required">*</font>产品图片
									</label>
								...
								<div className="form-group">
									<label className="col-sm-3 control-label">
										<font className="required">*</font>产品概述
									</label>
									<div className="col-sm-9">
								...
								<div className="form-group">
									<label className="col-sm-3 control-label">
										<font className="required">*</font>产品详情
									</label>
									<div className="col-sm-9">
								...
								<div className="form-group">
									<label className="col-sm-3 control-label">
										<font className="required">*</font>门市价（元）
									</label>
									<div className="col-sm-9">
								...
								<div className="form-group">
									<label className="col-sm-3 control-label">
										<font className="required">*</font>会员价（元）
									</label>
									<div className="col-sm-9">
								...
								<div className="form-group">
									<label className="col-sm-3 control-label">
										<font className="required">*</font>同行价（元）
									</label>
									<div className="col-sm-9">
								...
								<div className="form-group">
									<label className="col-sm-3 control-label">
										<font className="required">*</font>儿童价（元）
									</label>
									<div className="col-sm-9">
								...
								<div className="form-horizontal" role="form">
									...
									<div className="form-group">
										<label className="col-sm-3 control-label">
											<font className="required">*</font>联系电话
										</label>
										<div className="col-sm-9">
						...
						<div className="tab-pane fade" id="hotel">
							<div className="form-horizontal clearfix" role="form" id="hotel">
								...
								<div className="form-group">
									<div className="col-sm-offset-2 col-sm-9">
										<a type="submit" className="btn btn-primary" style={{ marginRight:"10px"}}
										   onClick={this._saveHotel.bind(this)}>保存</a>
										<a className="btn btn-default">取消</a>
									</div>
								</div>
							</div>
						...
						<div className="tab-pane fade" id="sight">
							<div className="form-horizontal clearfix" role="form" id="sight">
								...
								<div className="form-group">
									<div className="col-sm-offset-2 col-sm-9">
										<a type="submit" className="btn btn-primary" style={{ marginRight:"10px"}}
										   onClick={this._saveSight.bind(this)}>保存</a>
										<a className="btn btn-default">取消</a>
									</div>
								</div>
							</div>
						...
						<div className="tab-pane fade" id="car">
							<div className="form-horizontal clearfix" role="form" id="car">
								...
								<div className="form-group">
									<div className="col-sm-offset-2 col-sm-9">
										<a type="submit" className="btn btn-primary" style={{ marginRight:"10px"}}
										   onClick={this._saveCar.bind(this)}>保存</a>
										<a className="btn btn-default">取消</a>
									</div>
								</div>
							</div>
